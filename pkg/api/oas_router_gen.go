	...
	default:
		...
		case '/': // Prefix: "/todos"
			...
			if len(elem) == 0 {
				switch r.Method {
				case "GET":
					s.handleListTodosRequest([0]string{}, elemIsEscaped, w, r)
				case "POST":
			...
			case '/': // Prefix: "/"
				...
				if len(elem) == 0 {
					...
					case "DELETE":
						// Leaf: DeleteTodo
						r.name = "DeleteTodo"
						r.summary = "Delete a specific TODO item"
					...
					case "GET":
						// Leaf: GetTodo
						r.name = "GetTodo"
						r.summary = "Get a specific TODO item"
					...
					case "PUT":
						// Leaf: UpdateTodo
						r.name = "UpdateTodo"
						r.summary = "Update a specific TODO item"
